export function Footer() {
  return (
    <footer className="relative border-t border-white/5 bg-[#0E0E15]">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              The unified payment OS for businesses, creators, and global transfers.
            </p>
          </div>

          {/* Product */}
          <div>
            <h4 className="text-sm text-white mb-4">Product</h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Compliance</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            © 2025 Payd.plus. All rights reserved.
          </p>
